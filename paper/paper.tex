...
gate-voltage transfer is beyond the present model). Two features stand out. First, the linearity of Eq.~\eqref{eq:imb} means the
...
can be made. Next steps include driving the grid-refinement study to its
asymptotic regime (the 2-bin imbalance still shifts \SI{\approx 11.7}{\percent}
between the two finest grids and the fringe position has converged), a
realistic gate-voltage mapping, and many-body or decoherence studies.
