...
operating window ($|V_g|\lesssim\SI{0.3}{V}$, shaded in the figure) the response 
is linear, $\mathcal{I}\approx\mathcal{I}_0+S_V V_g$, with sensitivity 
$S_V\approx\SI{0.48}{V^{-1}}$ and $R^2=0.99997$. The recorded scan extends to 
...
$|V_g|\le\SI{0.3}{V}$) with a $\SI{50}{meV/V}$ coupling. (c) Linear fit in 
...
($|V_g|\le\SI{0.3}{V}$, shaded) is linear with sensitivity 
$S_V\approx\SI{0.48}{V^{-1}}$ and $R^2=0.99997$; the deeper-lens tail 
($|V_g|>\SI{0.3}{V}$) is an extrapolation of the phase model beyond the 
